...
def teste_completo():
    ...
    try:
        ...
        tenant_atualizado = cruds["tenant"].update(tenant_id, telefone="(11) 9999-8888")
        ...
        usuario_busca = cruds["usuario"].get_by_email(
            "carlos@financeira.com", tenant_id
        )
        ...
        cliente_atualizado = cruds["cliente"].update(
            cliente_id, tenant_id, renda_mensal=7000.00, score_credito=780
        )
        print(
            f"✅ Cliente atualizado! Nova renda: R$ {cliente_atualizado['renda_mensal']}"
        )

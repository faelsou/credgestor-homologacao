#!/usr/bin/env python3
"""
Script para criar usuário admin no CredGestor
...
ADMIN_EMAIL = "rodrigoconecteloja@gmail.com"
ADMIN_PASSWORD = "RodConect2026"
ADMIN_NAME = "Rodrigo Conecte Loja"
ADMIN_PHONE = "11992858462"
ADMIN_ROLE = "admin"

def create_auth_user(email: str, password: str, name: str, role: str, tenant_id: str, telefone: str):
...
def create_user_in_public_users(supabase: Client, user_id: str, email: str, name: str, role: str, tenant_id: str, telefone: str):
...
def create_tenant_user_link(supabase: Client, tenant_id: str, user_id: str, email: str, name: str, role: str, telefone: str):
...
def main():
    ...
    auth_user = create_auth_user(ADMIN_EMAIL, ADMIN_PASSWORD, ADMIN_NAME, ADMIN_ROLE, tenant_id, ADMIN_PHONE)
    if not auth_user:
    ...
    create_user_in_public_users(supabase, user_id, ADMIN_EMAIL, ADMIN_NAME, ADMIN_ROLE, tenant_id, ADMIN_PHONE)
    print()
    
    # 4. Criar vínculo em public.tenant_users
    print("📋 Passo 4: Criando vínculo em public.tenant_users...")
    create_tenant_user_link(supabase, tenant_id, user_id, ADMIN_EMAIL, ADMIN_NAME, ADMIN_ROLE, ADMIN_PHONE)
    print()
    ...
    try:
        ...
        if result.data:
            for tu in result.data:
                ...
                print(f"   Telefone: {tu.get('metadata', {}).get('telefone', 'N/A')}")

...
export const ClientsView: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('📋 Cliente a salvar:', clientToSave);
    setIsSavingClient(true);
    ...
    try {
      if (editingClientId) {
        ...
        const result = await addClient(clientToSave);
        console.log('✅ Resultado addClient:', result);
      }
          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                />
                {isFetchingCep && <Loader2 className="animate-spin text-emerald-600 mt-2" />}
              </div>
